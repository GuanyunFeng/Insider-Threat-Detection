...
class BERT(nn.Module):
    def __init__(self, embed=48, pad_size=32, dim_model=128, num_head=4, hidden=128,num_encoder=2,  num_classes=2, dropout=0.5 ):
...
class Encoder(nn.Module):
    def __init__(self, dim_model=128, num_head=4, hidden=1024, dropout=0.5):
...
class Positional_Encoding(nn.Module):
    def __init__(self, embed=48, pad_size=32, dropout=0.5):
